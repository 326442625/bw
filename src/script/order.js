            ...
            function getData(type) {
                ...
                switch (type) {
                    case '0':
                        ...
                        break;
                    case '1':
                        wUrl = '/me/order?f[0][column]=fCked&f[0][operator]=equal_to&f[0][query_1]=0&f[1][column]=fChecked&f[1][operator]=equal_to&f[1][query_1]=0&order_column=fDate&order_direction=desc';
                        break;
                    case '2':
                ...
                $.getData({
                    ...
                    success: function (data) {
                        ...
                        if (oReturn) {
                            $.loadMore(data.data, wUrl.substring(1, wUrl.length), callBack);
                        }
                    }
                })
            }
                ...
                $.each(data, function (index, el) {
                    ...
                    html += '<div class="JS_item">\
                              ...
                              <div class="bg-white">\
                                  ...
                                  <a href="/view/orderDetail.html?orderId='+el.fCode+'">\
                    ...
                    html += '</div>\
                              ...
                              <div class="border-top line-36 text-right bg-white font-13">\
